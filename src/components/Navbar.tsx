...
export default function Navbar() {
  ...
  return (
    <div
      className="flex justify-between items-center px-14 h-14 
  bg-[#212121] opacity-95 sticky top-0 z-50}"
    >
      ...
      <div className="flex items-center justify-center gap-5">
        ...
        >
          <div
            className="flex bg-zinc-900 items-center h-10
            px-4 pr-0"
          >
      ...
      <div className="flex gap-5 items-center text-xl">
        ...
        <div className="relative">
          ...
          text-xs bg-red-600 rounded-full px-1"
          >
            9+
          </span>
        </div>
